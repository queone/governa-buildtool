...
// --- CheckNestedFences / scanNestedFences tests ---
...
// temp directory and invokes CheckNestedFences directly.
...
// listMarkdownFiles skips tracked files that no longer exist on disk.
